...
marketing_email = os.environ.get("MERIT_QA_MARKETING_ADMIN_EMAIL", "marketing@meritlaunchers.com")
marketing_password = os.environ.get("MERIT_QA_MARKETING_ADMIN_PASSWORD", "marketing123")
