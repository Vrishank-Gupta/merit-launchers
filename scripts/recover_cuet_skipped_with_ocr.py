...
MANUAL_RECOVERY_CONFIG = {
    ...
    cfg_key("Mathematics", "PAPER 2"): {
        ...
        "patches": {
            1: {
                "prompt": "Write the degree of the differential equation (d²y/dx²)^2 + 3(dy/dx)^2 = x² log(d²y/dx²).",
                "options": ["3", "0", "1", "Not defined"],
                "correctIndex": 3,
            },
            3: {
                "prompt": "∫ 4^x 3^x dx equals:",
                "options": [
                    "12^x / log 12 + C",
                    "4^x / log 4 + C",
                    "(4^x · 3^x) / (log 4 · log 3) + C",
                    "3^x / log 3 + C",
                ],
                "correctIndex": 0,
            },
            4: {
                "prompt": "Write the degree and order of the differential equation (d²y/dx²) + (dy/dx)^(1/2) + x^(1/5) = 0.",
                "options": [
                    "Order not defined, degree 2",
                    "Order 2, degree 2",
                    "Order 2, degree not defined",
                    "Neither order defined nor degree defined",
                ],
                "correctIndex": 2,
            },
            5: {
                "prompt": "∫ (sin²x - cos²x) / (sin x cos x) dx equals:",
                "options": ["-log|cos 2x|", "-log|sin 2x|", "-log|sec 2x|", "None of these"],
                "correctIndex": 1,
            },
            6: {
                "prompt": "Integrate the function (1 - tan x) / (1 + tan x) with respect to x.",
                "options": [
                    "log|cos x + sin x| + C",
                    "log|cos x - sin x| + C",
                    "-log|cos x + sin x| + C",
                    "(1/2) log|sin x - cos x| + C",
                ],
                "correctIndex": 0,
            },
            7: {
                "prompt": "∫₀^(π/4) tan²x dx equals:",
                "options": ["1 - π/2", "1 - π/4", "1 + π/2", "1 + π/4"],
                "correctIndex": 1,
            },
            8: {
                "prompt": "∫ sin 2x cos 3x dx equals:",
                "options": [
            ...
            9: {
                "prompt": "Assume P, Q, R and S are matrices of order 2×m, k×n, m×2 and 2×3 respectively. The restrictions on k, m and n, so that PQ + RS is defined are",
                "options": [
                    "m = 3, n = 2",
                    "m = n, k is arbitrary",
                    "m = k, n is arbitrary",
            ...
            10: {
                "prompt": "ABCD is a parallelogram with AC and BD as diagonals. Then AC - BC =",
                "options": ["4AB", "3AB", "2AB", "AB"],
                "correctIndex": 3,
            },
            11: {
                "prompt": "The area enclosed by the curve y² = 4ax and its latus rectum is",
                "options": ["8/3 a²", "4/3 a²", "1/3 a²", "1/12 a²"],
                "correctIndex": 0,
            },
            12: {
                "prompt": "Write the degree of the differential equation [(d²y/dx²)^2 + (dy/dx)^2] = x sin(dy/dx).",
                "options": ["0", "2", "Not defined", "4"],
                "correctIndex": 2,
            },
            13: {
                "prompt": "In linear programming, the optimal value of the objective function is attained at the points given by",
                "options": [
            ...
            14: {
                "prompt": "The angle between the planes 2x - y + z - 6 and x + y + 2z - 3 is",
                "options": ["45°", "60°", "30°", "75°"],
                "correctIndex": 1,
            },
            15: {
            ...
            16: {
                "prompt": "The solution set of the inequation 2x + y > 5 is",
                "options": [
                    "The half plane that contains the origin",
            ...
            17: {
                "prompt": "Objective function of LPP is",
                "options": ["A constraint", "A function to be optimized", "The relation between the variables", "None of these"],
                "correctIndex": 1,
            },
            18: {
                "prompt": "The degree of the differential equation d²y/dx² + e^(dy/dx) = 0 is",
                "options": ["0", "Not defined", "defined", "1"],
                "correctIndex": 1,
            },
            20: {
                "prompt": "The maximum value of Z = 4x + 2y subject to the constraints 2x + 3y ≤ 18, x + y ≥ 10, x, y ≥ 0 is",
                "options": ["36", "40", "20", "None of these"],
                "correctIndex": 0,
            },
            21: {
                "prompt": "Consider the LPP: Minimize Z = 6x + 10y, subject to x ≥ 6, y ≥ 2, 2x + y ≥ 10, x, y ≥ 0. Redundant constraints in this LPP are",
                "options": ["x ≥ 0, y ≥ 0", "x ≥ 6, 2 + y ≥ 10", "2x + y ≥ 10", "None of these"],
                "correctIndex": 2,
            },
            22: {
                "prompt": "If one ball is drawn at random from each of three boxes containing 3 white and 1 black, 2 white and 2 black, 1 white and 3 black balls, then the probability that 2 white and 1 black ball will be drawn is",
                "options": ["13/32", "1/4", "1/32", "13/33"],
                "correctIndex": 0,
            },
            23: {
                "prompt": "If A, B are two events associated to a random experiment such that P(A ∩ B) = 7/10 and P(B) = 17/20, then P(A/B) =",
                "options": ["14/17", "17/20", "7/8", "1/8"],
                "correctIndex": 0,
            },
            24: {
                "prompt": "The shortest distances of the point (1, 2, 3) from x, y, z axes respectively are",
                "options": ["1, 2, 3", "√5, √13, √10", "√10, √13, √5", "√13, √10, √5"],
                "correctIndex": 3,
            },
            25: {
                "prompt": "Three persons A, B and C were given a task, whose probabilities of completion on time are 1/3, 1/4 and 1/5 respectively. They were asked to complete the task independently. The probability that exactly one of them complete the task on time is",
                "options": ["2/15", "2/5", "3/20", "13/30"],
                "correctIndex": 3,
            },
            26: {
                "prompt": "Evaluate cot(sin^-1(3/4) + sec^-1(4/3)).",
                "options": ["-1", "1", "0", "None of these"],
                "correctIndex": 2,
            },
            27: {
                "prompt": "cos(sec^-1 x + csc^-1 x), |x| ≥ 1 equals",
                "options": ["-1", "1", "0", "None of these"],
                "correctIndex": 2,
            },
            28: {
                "prompt": "Solve: sin[sin^-1(1/5) + cos^-1 x] = 1",
                "options": ["x = 1/5", "x = -1/5", "x = 0", "None of these"],
                "correctIndex": 0,
            },
        },
        "skips": {
            2: "Only three options are visible across the recovered source pages.",
            19: "Integral expression is incomplete even after page rendering.",
            29: "Trailing trigonometric block remains incomplete.",
            30: "Trailing trigonometric block remains incomplete.",
            31: "Trailing trigonometric block remains incomplete.",
            32: "Later-page content has not been manually reconstructed yet.",
            33: "Later-page content has not been manually reconstructed yet.",
            34: "Later-page content has not been manually reconstructed yet.",
            35: "Later-page content has not been manually reconstructed yet.",
            36: "Later-page content has not been manually reconstructed yet.",
            37: "Later-page content has not been manually reconstructed yet.",
            38: "Later-page content has not been manually reconstructed yet.",
            39: "Later-page content has not been manually reconstructed yet.",
            40: "Later-page content has not been manually reconstructed yet.",
            41: "Later-page content has not been manually reconstructed yet.",
            42: "Later-page content has not been manually reconstructed yet.",
            43: "Later-page content has not been manually reconstructed yet.",
            44: "Later-page content has not been manually reconstructed yet.",
            45: "Later-page content has not been manually reconstructed yet.",
            46: "Later-page content has not been manually reconstructed yet.",
            47: "Later-page content has not been manually reconstructed yet.",
            48: "Later-page content has not been manually reconstructed yet.",
            49: "Later-page content has not been manually reconstructed yet.",
            50: "Later-page content has not been manually reconstructed yet.",
        },
    },
    ...
    cfg_key("Mathematics", "PAPER 1"): {
        ...
        "patches": {
            1: {
                "prompt": "If O is origin and C is the mid-point of A(2, -1) and B(-4, 3), then the value of vector OC is:",
                "options": ["i + j", "i - j", "-i + j", "-i - j"],
                "correctIndex": 2,
            },
            2: {
                "prompt": "The angle between the vectors a + b and a - b, where a = i + j + 4k and b = i - j + 4k, is:",
                "options": ["90°", "45°", "30°", "15°"],
                "correctIndex": 0,
            },
            3: {
                "prompt": "If |a| = 3 and |b| = 4, then the value of β for which a + βb is perpendicular to a - βb is:",
                "options": ["9/16", "3/4", "3/2", "4/3"],
                "correctIndex": 1,
            },
            4: {
                "prompt": "Maximize Z = 3x + 5y, subject to x + 4y ≤ 24, 3x + y ≤ 21, x + y ≤ 9, x ≥ 0, y ≥ 0.",
                "options": ["20 at (1,0)", "30 at (0,6)", "37 at (4,5)", "33 at (6,3)"],
                "correctIndex": 2,
            },
            6: {
                "prompt": "Maximize Z = 7x + 11y, subject to 3x + 5y ≤ 26, 5x + 3y ≤ 30, x ≥ 0, y ≥ 0.",
                "options": ["59 at (9/2, 5/2)", "42 at (6,0)", "49 at (7,0)", "57.2 at (0, 5.2)"],
                "correctIndex": 0,
            },
            7: {
                "prompt": "Maximize Z = 6x + 4y, subject to x ≤ 2, x + y ≤ 3, -2x + y ≤ 1, x ≥ 0, y ≥ 0.",
                "options": ["12 at (2,0)", "140/3 at (2/3, 7/3)", "16 at (2,1)", "4 at (0,1)"],
                "correctIndex": 2,
            },
            8: {
                "prompt": "Write the value of tan[(sin^-1 x + cos^-1 x) / 2], when x = √3 / 2.",
                "options": ["-1", "1", "0", "1/2"],
                "correctIndex": 1,
            },
            9: {
                "prompt": "Write the value of sec^-1(1/2).",
                "options": ["±1", "∞", "Not defined", "∅"],
                "correctIndex": 2,
            },
            10: {
                "prompt": "Write the value of sin^-1(sin 3π/5).",
                "options": ["π/5", "3π/5", "4π/5", "2π/5"],
                "correctIndex": 3,
            },
            11: {
                "prompt": "The solution of the differential equation dy/dx = (x^2 + xy + y^2) / x^2 is:",
                "options": [
                    "tan^-1(x / y) = log y + c",
                    "tan^-1(y / x) = log x + c",
                    "tan^-1(x / y) = log x + c",
            ...
            12: {
                "prompt": "The differential equation dy/dx + Py = Qy^n, n > 2 can be reduced to linear form by substituting:",
                "options": ["z = y^n", "z = y^(n-1)", "z = y^(1-n)", "z = y''"],
                "correctIndex": 2,
            },
            13: {
                "prompt": "If x = a(cosθ + θ sinθ), y = a(sinθ - θ cosθ), then d²y/dx² =",
            ...
            17: {
                "prompt": "If A and B are two events associated with a random experiment such that P(A) = 0.8, P(B) = 0.5, P(B|A) = 0.4, find P(A ∩ B).",
                "options": ["0.36", "0.32", "0.31", "0.30"],
                "correctIndex": 1,
            },
            18: {
                "prompt": "Two integers are selected at random from 1 through 11. If the sum is even, find the probability that both the numbers are odd.",
                "options": ["3/5", "1/5", "2/5", "4/5"],
                "correctIndex": 0,
            },
            19: {
                "prompt": "y = x(x - 3)^2 decreases for the values of x given by:",
                "options": ["1 < x < 3", "x < 0", "x > 0", "0 < x < 3/2"],
                "correctIndex": 0,
            },
            20: {
                "prompt": "A black and a red die are rolled. Find the conditional probability of obtaining a sum greater than 9, given that the black die resulted in 5.",
                "options": ["3/5", "1/3", "2/3", "None of these"],
                "correctIndex": 1,
            },
            21: {
                "prompt": "Three cards are drawn with replacement from a well-shuffled pack of cards. Find the probability that the cards drawn are king, queen and jack.",
                "options": ["6/2197", "12/2197", "36/2197", "150/2197"],
                "correctIndex": 0,
            },
            22: {
                "prompt": "cos^-1(cos 7π/6) is equal to",
                "options": ["7π/6", "5π/6", "π/3", "π/6"],
                "correctIndex": 1,
            },
            23: {
                "prompt": "The value of tan^-1[tan(3π/4)] is:",
                "options": ["π/3", "-π/3", "π/4", "-π/4"],
                "correctIndex": 3,
            },
            24: {
                "prompt": "The value of sin^-1[sin(-17π/8)] is:",
                "options": ["-π/6", "π/8", "-π/8", "π/12"],
                "correctIndex": 2,
            },
            25: {
                "prompt": "If A and B are two matrices of order 3 × m and 3 × n respectively and m = n, then the order of 5A - 2B is",
                "options": ["m × 3", "3 × 3", "m × n", "3 × n"],
                "correctIndex": 3,
            },
            26: {
                "prompt": "If π/2 ≤ x ≤ 3π/2 and y = sin^-1(sin x), solve dy/dx.",
                "options": ["1", "-1", "0", "±1"],
                "correctIndex": 1,
            },
            27: {
                "prompt": "The number of all possible matrices of order 3 × 3 with each entry 0 or 1 is",
                "options": ["27", "18", "81", "512"],
                "correctIndex": 3,
            },
            28: {
                "prompt": "If A is a square matrix such that A² = I, then {(A - I)^3} + {(A + I)^3} - 7A is equal to",
                "options": ["A", "I - A", "I + A", "3A"],
                "correctIndex": 0,
            },
            29: {
                "prompt": "The matrix A = [[0, -5, 8], [5, 0, 12], [-8, -12, 0]] is a",
            ...
            33: {
                ...
                "options": ["Yes", "No", "Cannot determine", "Both"],
                "correctIndex": 0,
            },
            34: {
            ...
            38: {
                "prompt": "The function f(x) = [ln(1+ax) - ln(1-bx)] / x is not defined at x = 0. The value to be assigned to f at x = 0 so that it is continuous there is",
            ...
            42: {
                ...
                "options": [
                    ...
                    "P(X=0,1,2,3) = 1/216, 15/216, 75/216, 125/216",
                ],
                "correctIndex": 0,
            },
            43: {
                "prompt": "If y = sin^-1x + cos^-1x, solve dy/dx.",
                "options": ["0", "1", "2", "4"],
                "correctIndex": 0,
            },
            44: {
                "prompt": "If y = √(sin x + y), then dy/dx =",
                "options": [
                    "sin x / (2y - 1)",
                    "sin x / (1 - 2y)",
                    "cos x / (1 - 2y)",
            ...
            45: {
                "prompt": "Find the equation of the plane through the intersection of the planes 3x - 4y + 5z = 10 and 2x + 2y - 3z = 4 and parallel to the line x = 2y = 3z.",
                "options": ["x - 10y + 27z = 14", "x - 20y + 27z = 14", "x - 20y + 26z = 14", "x - 10y + 27z = 13"],
                "correctIndex": 1,
            },
            46: {
            ...
            47: {
                "prompt": "If |a × b| = 4 and |a.b| = 2, then |a|² |b|² is equal to:",
                "options": ["4", "6", "20", "2"],
                "correctIndex": 2,
            },
            48: {
                "prompt": "The side of an equilateral triangle is increasing at the rate of 2 cm/s. The rate at which area increases when the side is 10 is",
