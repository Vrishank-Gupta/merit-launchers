...
import { GraduationCap, Scale, Atom, Microscope, FileText, BookOpen, TrendingUp, ArrowRight, Shield } from "lucide-react";
...
const courses = [
  ...
  },
  {
    ...
    title: "GAT and Maths",
    icon: Shield,
    description: "Separate GAT and Maths mock tests for defence aspirants",
    path: "/courses/nda",
