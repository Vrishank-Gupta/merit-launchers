      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 gap-8 mb-8 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="text-sm opacity-90 mb-4">
              Launch Your Future with India&apos;s most comprehensive mock test
              platform.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-2 text-sm opacity-90">
                ...
                <a
                  href="mailto:info@meritlaunchers.com"
            ...
            <div className="flex items-center space-x-3 mt-4">
              <a
                href="https://www.facebook.com/61583046760574/"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-primary transition-colors"
                aria-label="Facebook"
              ...
              <a
                href="https://www.instagram.com/merit_launchers/"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-primary transition-colors"
              ...
              <a
                href="https://x.com/meritlaunchers"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-primary transition-colors"
                aria-label="X"
              ...
              <a
                href="https://www.linkedin.com/company/merit-launchers/"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-primary transition-colors"
                aria-label="LinkedIn"
        ...
        <div className="border-t border-white/10 pt-6 mt-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm opacity-75">{"\u00A9"} {currentYear} Merit Launchers. All rights reserved.</p>
